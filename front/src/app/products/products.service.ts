...
export class ProductsService {
    ...
    create(prod: Product): Observable<Product[]> {
        this.http.post<any>('http://localhost:8000/api/products', prod).subscribe(data => {
    ...
    update(prod: Product): Observable<Product[]>{
        this.http.put<any>(`http://localhost:8000/api/products/${prod.id}`, prod).subscribe(data => {
    ...
    delete(id: number): Observable<Product[]>{
        this.http.delete<any>(`http://localhost:8000/api/products/${id}`).subscribe(data => {
